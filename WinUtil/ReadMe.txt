========================================================================
    ACTIVE TEMPLATE LIBRARY : WinUtil Project Overview
========================================================================

AppWizard has created this WinUtil project for you to use as the starting point for
...
_WinUtil.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_WinUtil.h)
        GUID definitions                                (_WinUtil_i.c)
        A type library                                  (_WinUtil.tlb)
        Marshaling code                                 (_WinUtil_p.c and dlldata.c)
WinUtil.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named WinUtil.pch and a precompiled types file named StdAfx.obj.
...
WinUtilps.vcproj
	...
	dlldata.c, WinUtil_i.c and WinUtil_p.c which are required
