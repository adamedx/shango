...
namespace Shango
{
	...
	/// </summary>
    public class MainWindow : System.Windows.Forms.Form, ICommandEnvironment, ITerminalInput
    {
        /// <summary>
        ...
        public MainWindow( string[] Arguments )
        {
            ...
            InternalCommandFactory internalFactory = new InternalCommandFactory( Terminal );

			_CommandProcessor = new StandardCommandProcessor( this, (ICommandFactory) internalFactory, Terminal, 50 );
            ...
            ToggleBackground()
        {
            if ( null == _Backform )
            {
                ...
                //BackColor = Color.FromArgb(128,1,2,3);
